     ...
     justify-center gap-10 md:gap-32 py-10 border-b border-white/30'>
        ...
        <div className='hidden md:flex flex-col items-start w-full'>
           ...
           <div className='flex items-center gap-2 pt-4'>
             ...
             <button className='bg-blue-600 w-24 h-9 text-white rounded'>Subscibe</button>
           </div>
        </div>
     </div>
     <p className='py-4 text-center text-xs md:text-sm text-white/60'>copyright 2025 © Ademy. All Right Reserved</p>
   </footer>
